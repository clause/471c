...
def _identifier_from_message(message: str) -> str | None:
    unbound = re.search(r"unknown variable:\s*([A-Za-z_][A-Za-z0-9_]*)", message)
    if unbound:
